...
class WAActionSheetController: UIAlertController {

    func addAction(title: String, titleTextColor: UIColor?, titleFont: UIFont?, icon: UIImage?, iconColor: UIColor?, handler: ((UIAlertAction) -> Void)? = nil) {
    ...
    func addSystemAction(title: String?, style: UIAlertAction.Style, handler: ((UIAlertAction) -> Void)?) {
